...
(function ($) {
    ...
    function dateInputSetCurrentDate(id, Condition) {
        var now = new Date();
        ...
        if (Condition == 'Date') {
            ...
            $('#' + id).val(now.getHours() + ':' + now.getMinutes());

        }
        else if (Condition == 'DateTime') {

            $('#' + id).val(today + 'T' + now.getHours() + ':' + now.getMinutes());
        }
    }
    function dateInputSetCurrentDateUsingClass(cls, Condition) {
        var now = new Date();
        var day = ("0" + now.getDate()).slice(-2);
        var month = ("0" + (now.getMonth() + 1)).slice(-2);
        ...
        if (Condition == 'Date') {
            ...
            $('.' + cls).val(now.getHours() + ':' + now.getMinutes());

        }
        else if (Condition == 'DateTime') {

            $('.' + cls).val(today + 'T' + now.getHours() + ':' + now.getMinutes());
        }
    }
